-- Mettre à jour la fonction handle_new_user pour détecter les super admins
...
'Crée automatiquement un profil pour chaque nouvel utilisateur. Si is_super_admin=true dans metadata, ne crée pas le profil (géré par create_super_admin RPC). Utilise les données de user_metadata si disponibles.';
